            ...
            >
              ...
              >
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <div className="bg-white/5 hover:bg-white/[.08] border border-white/10 rounded-xl p-6 sm:p-8 h-full flex flex-col items-center justify-center transition-all duration-300 cursor-pointer group">
