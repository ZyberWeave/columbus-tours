...
const TourDetailPageClient: React.FC<TourDetailPageClientProps> = ({ tour }) => {
  ...
  // Tour details for quick info cards
  const tourDetails = [
    {
      label: "Duration",
      value: tour.duration
  ...
  // Sample itinerary data (replace with actual data as needed)
  const itinerary = [
    {
      day: 1,
  ...
  // Make sure there are no stray braces or code here
  
  return (
    <main className="w-full mx-auto px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
      {/* Header Section */}
      <motion.header
      ...
      {/* Slideshow Hero Section with CTA Below */}
      <motion.section
        className="mb-10 rounded-xl overflow-hidden shadow-lg relative"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.section
        className="bg-gradient-to-r from-[#D32F2F] to-[#B71C1C] rounded-xl shadow-xl p-8 text-white mb-12"
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        viewport={{ once: true }}
      >
        <div className="w-[93vw] mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">
            Book Your Next Adventure Now
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Ready to embark on a memorable journey? Our experts are here to assist
            with trip details, customization, and more.
          </p>
        ...
        {tourDetails.map((detail, index) => (
          ...
          >
            <detail.icon
              ...
              aria-hidden="true"
            />
            <h3 className="font-medium text-gray-600 mb-1">{detail.label}</h3>
      ...
      {/* Navigation Tabs */}
      <motion.div
        className="flex overflow-x-auto mb-8 bg-white rounded-lg shadow-md border border-gray-100"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        {[
          ...
          <button
            ...
            className={`flex items-center px-6 py-4 text-sm font-medium whitespace-nowrap border-b-2 transition-colors duration-300 ${
              activeTab === tab.id
      ...
      {/* Contact Us Section */}
      <section className="w-[100vw]] mx-auto bg-gradient-to-br from-[#0A122A] to-[#1B2738] py-24 px-4 relative overflow-hidden mb-12">
        ...
        <div className="w-[93vw] mx-auto text-center relative z-10">
          <motion.div
            className="mb-16"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                <div className="bg-white/5 hover:bg-white/[.08] border border-white/10 rounded-xl p-8 h-full flex flex-col items-center justify-center transition-all duration-300 cursor-pointer group">
                  ...
                  <h3 className="text-xl font-bold text-[#F7E7CE] mb-3">
                    Chat Now
                  </h3>
