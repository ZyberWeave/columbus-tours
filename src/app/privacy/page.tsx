...
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen bg-[#FFFFFF] py-12 px-4 sm:px-6 lg:px-8">
      <section className="max-w-4xl mx-auto bg-[#F7F7F7] p-8 shadow-lg rounded-lg">
        <h1 className="text-4xl font-bold text-[#D32F2F] mb-6">Privacy Policy</h1>
        ...
        <h2 className="text-2xl font-bold text-[#D32F2F] mb-4">Information We Collect</h2>
        ...
        <h2 className="text-2xl font-bold text-[#D32F2F] mb-4">How We Use Your Information</h2>
        ...
        <h2 className="text-2xl font-bold text-[#D32F2F] mb-4">Data Sharing and Disclosure</h2>
        <p className="text-[#333333] mb-4">
        ...
        <h2 className="text-2xl font-bold text-[#D32F2F] mb-4">Data Security</h2>
        <p className="text-[#333333] mb-4">
        ...
        <h2 className="text-2xl font-bold text-[#D32F2F] mb-4">Your Rights</h2>
        <p className="text-[#333333] mb-4">
          ...
          <a href="mailto:info@columbustours.com" className="text-[#1976D2] hover:underline">
            info@columbustours.com
          </a>
          .
        </p>

        <h2 className="text-2xl font-bold text-[#D32F2F] mb-4">Cookies and Tracking Technologies</h2>
        <p className="text-[#333333] mb-4">
        ...
        <h2 className="text-2xl font-bold text-[#D32F2F] mb-4">Changes to This Privacy Policy</h2>
        <p className="text-[#333333] mb-4">
        ...
        <h2 className="text-2xl font-bold text-[#D32F2F] mb-4">Contact Information</h2>
        <p className="text-[#333333] mb-4">
          If you have any questions or concerns regarding this Privacy Policy or our privacy practices, please contact us
          at:
        </p>
        <ul className="list-disc list-inside text-[#333333] mb-4">
          <li>
            Email:{" "}
            <a href="mailto:info@columbustours.com" className="text-[#1976D2] hover:underline">
              info@columbustours.com
          ...
          <li>
            Phone:{" "}
            <a href="tel:+18956273122" className="text-[#1976D2] hover:underline">
              +1 (895) 627-3122
            </a>
          </li>
          <li>
        ...
        <p className="text-[#333333] text-center text-sm mt-8">
